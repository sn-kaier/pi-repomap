...
Once finished,
- rename `TODO.md` file to a proper name:
E.g. `todo-01-project-bootstrap.md` where the prefix is `todo-` followed by a contiguous number and a descriptive title.
- move the renamed TODO file to `./finished-todos`
